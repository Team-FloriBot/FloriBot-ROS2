...
(cl:defmethod cl:initialize-instance :after ((m <Angle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Angle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name base-msg:<Angle> is deprecated: use base-msg:Angle instead.")))
...
(cl:defmethod angle-val ((m <Angle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader base-msg:angle-val is deprecated.  Use base-msg:angle instead.")
  (angle m))
