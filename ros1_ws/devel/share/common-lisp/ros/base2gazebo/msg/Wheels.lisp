...
(cl:defmethod cl:initialize-instance :after ((m <Wheels>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Wheels)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name base2gazebo-msg:<Wheels> is deprecated: use base2gazebo-msg:Wheels instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Wheels>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader base2gazebo-msg:header-val is deprecated.  Use base2gazebo-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'frontLeft-val :lambda-list '(m))
(cl:defmethod frontLeft-val ((m <Wheels>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader base2gazebo-msg:frontLeft-val is deprecated.  Use base2gazebo-msg:frontLeft instead.")
  (frontLeft m))

(cl:ensure-generic-function 'frontRight-val :lambda-list '(m))
(cl:defmethod frontRight-val ((m <Wheels>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader base2gazebo-msg:frontRight-val is deprecated.  Use base2gazebo-msg:frontRight instead.")
  (frontRight m))

(cl:ensure-generic-function 'rearLeft-val :lambda-list '(m))
(cl:defmethod rearLeft-val ((m <Wheels>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader base2gazebo-msg:rearLeft-val is deprecated.  Use base2gazebo-msg:rearLeft instead.")
  (rearLeft m))

(cl:ensure-generic-function 'rearRight-val :lambda-list '(m))
(cl:defmethod rearRight-val ((m <Wheels>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader base2gazebo-msg:rearRight-val is deprecated.  Use base2gazebo-msg:rearRight instead.")
  (rearRight m))
